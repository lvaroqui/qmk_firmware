...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    KC_TRANSPARENT, FR_HASH,         FR_PLUS,           FR_AMPR,          FR_DQUO,           FR_PND, /* */     FR_QUES,      FR_PIPE,         FR_TILD,       FR_PERC,        FR_GRV,          KC_F12,
    ...
    KC_TRANSPARENT, FR_AT,           FR_BSLS,           LT(0,FR_ASTR),    LT(0,FR_DOT),      FR_EURO,  /* */     KC_NO,        FR_RPRN,         FR_RBRC,       FR_RCBR,        FR_RABK,         KC_NO,
